            ...
            <div class="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
                <div class="md:w-1/2 px-8">
                    ...
                    <form action="" class="flex flex-col gap-4">
                        ...
                        <input class="p-2 rounded-xl border w-full" type="password" name="password" id="password" placeholder="Confirm Password" />
                        <button class="bg-[#002D74] text-white py-2 mt-8 rounded-xl hover:scale-105 duration-300 hover:bg-[#206ab1] font-medium" type="submit">Register</button>
                    </form>
